...
using Teste.RotaViagem.Application.Extensions;
using Teste.RotaViagem.Domain.Travels;
using Teste.RotaViagem.Domain.Travels.Contracts;
using Teste.RotaViagem.Infra.Extensions;
using static Teste.RotaViagem.IntegrationTests.Fixtures;

namespace Teste.RotaViagem.IntegrationTests.Application.Travels.TravelServiceTests;
