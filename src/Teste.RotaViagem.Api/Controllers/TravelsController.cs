...
using Teste.RotaViagem.Api.Models.Requests;
using Teste.RotaViagem.Application;
using Teste.RotaViagem.Domain.Travels;
using Teste.RotaViagem.Domain.Travels.Contracts;

namespace Teste.RotaViagem.Api.Controllers;
...
public class TravelsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetCheapestTravelAsync(string from, string to)
    {
        if (string.IsNullOrEmpty(from) || string.IsNullOrEmpty(to))
            return BadRequest(Error.Create("INVALID_PARAMETERS", "Ponto de partida ou ponto de destino ausente"));
